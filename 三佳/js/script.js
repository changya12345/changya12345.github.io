...
var btn=document.querySelectorAll(".btn8");
var jb=document.querySelectorAll(".shop-JB");
console.log(btn)
var span=document.querySelectorAll(".btn8 p span");
var img=document.querySelectorAll(".btn8 p img");
for(var i=0;i<jb.length;i++){
    jb[i].style.display="none";
    btn[i].index=i;
    btn[i].onclick=function(){
        if(jb[this.index].style.display==="none"){
            jb[this.index].style.display="block";
            span[this.index].innerHTML="收起分类";
            img[this.index].src="img/sanjiao.png";
        }else{
            jb[this.index].style.display="none";
            span[this.index].innerHTML="展开更多";
            img[this.index].src="sort-img/bottom.jpg";
        }
    }
}
